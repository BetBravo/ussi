...
class InsumoSuministradoController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('insumosuministrado_show', array('id' => $insumoSuministrado->getId()));
        }
    ...
    public function editAction(Request $request, InsumoSuministrado $insumoSuministrado)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('insumosuministrado_edit', array('id' => $insumoSuministrado->getId()));
        }
